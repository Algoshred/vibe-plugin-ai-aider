...
```bash
vibe plugin install @vibecontrols/vibe-plugin-ai-aider
```

Or install the npm package directly into an existing project that hosts the VibeControls agent:

```bash
bun add @vibecontrols/vibe-plugin-ai-aider
# or
npm install @vibecontrols/vibe-plugin-ai-aider
```
...
- npm: <https://www.npmjs.com/package/@vibecontrols/vibe-plugin-ai-aider>
- Source: <https://github.com/algoshred/vibe-plugin-ai-aider>
- Plugin contract / SDK: <https://github.com/algoshred/vibecontrols-plugin-sdk>
- Plugin catalogue: <https://vibecontrols.com/plugins/ai-aider>
